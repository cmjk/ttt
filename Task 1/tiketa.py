...
# so, we construct a list of img elements look at their alt property
...
# the slow scrolling animation on the results pages causes to our clicks to become intercepted by the cookies banner
# one workaround for this behaviour is to click using js
# another option would be to write our own EC class with a try/except block
